...
export const Login: React.FC = () => {
  ...
  return (
    <div className="font-display bg-[#FFF5E6] text-[#4a4a4a] min-h-screen flex flex-col overflow-hidden relative">
      ...
      <div className="absolute top-20 left-20 text-6xl opacity-80 animate-float blur-[1px]">
        🍕
      </div>
      <div className="absolute bottom-32 left-32 text-5xl opacity-60 animate-float-delayed blur-[1px]">
        🥗
      </div>
      <div className="absolute top-32 right-32 text-6xl opacity-80 animate-float-delayed blur-[1px]">
        🍔
      </div>
      <div className="absolute bottom-20 right-20 text-5xl opacity-60 animate-float blur-[1px]">
        🍩
      </div>
      <div className="absolute top-1/2 left-10 text-4xl opacity-40 animate-float blur-[2px]">
        🥑
      </div>
      <div className="absolute top-1/3 right-10 text-4xl opacity-40 animate-float-delayed blur-[2px]">
        🌮
      </div>
        ...
        <div className="w-full max-w-md bg-[#FFFDF5] rounded-[40px] shadow-clay-card p-8 md:p-12 border border-white/60 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-10">
              <h2 className="text-3xl font-black text-[#23170f] mb-2 tracking-tight">
                Welcome Back!
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label
                  className="block text-sm font-bold text-[#4a4a4a] ml-1"
                  htmlFor="email"
                >
                  Email
                </label>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-end pt-1">
                  <a
                    className="text-sm font-bold text-[#fa8c47] hover:text-[#e57a36] transition-colors"
                    href="#"
                  >
                    Forgot Password?
                  </a>
